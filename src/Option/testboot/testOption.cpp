...
BOOST_AUTO_TEST_CASE(Test_Option){
    ...
    Call opcionCallDelta (0.01,100,100,0.5,4.0);
    Put opcionPutTheta (0.08,300.0,305.0,0.25,4.0/12.0);
    Call opcionCallVega (0.08,300,305,0.25,4.0/12.0);
    ...
    Call opcionCallDelta1 (0.08,100,305,0.25,4.0);
    Put opcionPutTheta1 (0.08,300.0,305.0,0.25,4.0/12.0);
    Call opcionCallVega1 (0.08,300,305,0.25,4.0/12.0);
